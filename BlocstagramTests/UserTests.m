...
-(void) testThatInitializationWorks{
    ...
    User *testUser = [[User alloc] initWithDicionary:sourceDictionary];
    ...
    XCTAssertEqualObjects(testUser.profilePictureURL, [NSURL URLWithString:sourceDictionary[@"profile_picture"]], @"The profile picture should be equal");//what?
}
