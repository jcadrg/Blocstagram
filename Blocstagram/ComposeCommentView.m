...
//ASK why in this method we are overriding the setter
...
-(void) setIsWritingComment:(BOOL)isWritingComment animated:(BOOL) animated{
    ...
    if (animated) {
        ...
        [UIView animateWithDuration:0.2 delay:0 usingSpringWithDamping:0.4 initialSpringVelocity:0.2 options:kNilOptions animations:^{
...
//Same as above, why is this method used?
